...
public class ItemListActivityTest {
    ...
    public void itemListActivityTest() {
        ...
        ViewInteraction recyclerView2 = onView(
                allOf(withId(R.id.rv_item_steps), isDisplayed()));
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.btn_next_step), withText("Next"), isDisplayed()));
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.btn_previous_step), withText("Previous"), isDisplayed()));
